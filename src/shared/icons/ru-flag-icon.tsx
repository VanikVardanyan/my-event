...
interface ILikeIconProps extends IIcons {
  fillBg?: string
}

const RusFlgIcon = (props: ILikeIconProps) => {
  const { style, fill = White, fillBg = 'transparent' } = props
  const defaultStyle = { width: 30, height: 30 }

  return (
    <svg xmlns="http://www.w3.org/2000/svg" style={defaultStyle} viewBox="0 0 32 32">
